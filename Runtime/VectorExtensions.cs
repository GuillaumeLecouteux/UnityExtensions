...
namespace JauntyBear.UnityExtensions
{
	...
	public static class VectorExtensions
	{
		...
		{
			return new Vector2(
				MathfExtensions.FloorMod(thisVector.x, otherVector.x), 
				MathfExtensions.FloorMod(thisVector.y, otherVector.y));
		}
		...
		public static Vector3 HadamardMod(this Vector3 thisVector, Vector3 otherVector)
		{
			return new Vector3(
				MathfExtensions.FloorMod(thisVector.x, otherVector.x), 
				MathfExtensions.FloorMod(thisVector.y, otherVector.y),
				MathfExtensions.FloorMod(thisVector.z, otherVector.z));
		}
		...
		public static Vector4 HadamardMod(this Vector4 thisVector, Vector4 otherVector)
		{
			return new Vector4(
				...
				MathfExtensions.FloorMod(thisVector.y, otherVector.y),
				MathfExtensions.FloorMod(thisVector.z, otherVector.z),
				MathfExtensions.FloorMod(thisVector.w, otherVector.w));
		}
		...
		public static void DrawXYCross(this Vector3 position, Color color, float size = 0.5f, float duration = 1f)
		{
		...
		public static void DrawCross(this Vector2 position, Color color, float size = 0.5f, float duration = 1f)
		{
			Debug.DrawLine(position + Vector2.left * size, position + Vector2.right * size, color, duration);	
			Debug.DrawLine(position + Vector2.up * size, position + Vector2.down * size, color, duration);
		}
		#endregion
	}
